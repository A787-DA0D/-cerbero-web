      ...
      <div className="relative z-10">
        ...
        <header className="mb-8 space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-xs tracking-[0.25em] text-cyan-300/80 uppercase">
              CAPITAL ENGINE
            </p>
            ...
            <p className="mt-1 text-sm text-white/65 max-w-2xl">
              Il tuo capitale operativo in USDC, custodito nel tuo smart
              contract 1-a-1 su Arbitrum. Sempre visibile, sempre sotto il tuo
              controllo.
            </p>
          </div>
        </header>
            ...
            >
              ...
              <div className="mt-3">
                ...
                <p className="mt-1 text-xs text-white/60 leading-relaxed">
                  Il capitale vive nel tuo smart contract intestato a te.
                  Cerbero ha solo il telecomando operativo, non le chiavi della
                  cassaforte.
                </p>
              </div>
            ...
            {movements.length > 0 ? (
              ...
              !isLoadingMovements && (
                <p className="text-xs text-white/50">
                  Appena effettuerai il primo deposito o movimento, lo vedrai
                  qui.
                </p>
              )
            )}
